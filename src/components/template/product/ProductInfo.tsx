    ...
    return (
        <div className='  w-[450px]'>
            <div className='border-b border-gray-400 flex-col flex gap-3 '>
                <h2 className='text-2xl '>Havic HV G-92 Gamepad</h2>
                ...
                <p className='mb-6'>PlayStation 5 Controller Skin High quality vinyl with air channel adhesive for easy bubble free install & mess free removal Pressure sensitive.</p>
            </div>
